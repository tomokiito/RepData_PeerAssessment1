...
**Filling in all of the missing values by the average number of steps
taken each day and each interval**
...
Next, joining the average number of steps taken each day and each
interval,and calculate the interpolation
